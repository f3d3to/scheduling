...
urlpatterns = [
    ...
    path('grafos/<int:plan_id>/', VisualizacionGrafoRetrieveUpdateDestroyView.as_view(), name='visualizaciongrafo-detail'),
    path('grafos/filtrado/<int:plan_id>/', GrafoFiltradoView.as_view(), name='grafo_filtrado'),
]