...
urlpatterns = [
    ...
    path('actividades/', views.ActividadPlanificadaListCreateView.as_view(), name='actividad-list-create'),
    path('actividades/<int:pk>/', views.ActividadPlanificadaDetailView.as_view(), name='actividad-detail'),
]