    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tabla', models.JSONField(default={(1, 1): {'contenido': '', 'id': ''}, (1, 2): {'contenido': '', 'id': ''}, (2, 1): {'contenido': '', 'id': ''}, (2, 2): {'contenido': '', 'id': ''}}, help_text='Representación de la tabla como diccionario.')),
            ],
            options={
                'abstract': False,
            },
